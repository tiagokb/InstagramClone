package com.tiagokontarski.instagramclone.main.presentation.fragments.search.presentation;
...
public class MainSearchFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        rv = view.findViewById(R.id.main_search_rv);
    ...
    private class MockAdapter extends RecyclerView.Adapter<MockViewHolder> {
        ...
        public MockViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View root = getLayoutInflater().inflate(R.layout.item_rv_main_search, parent, false);
